...
export const GET_DELETED_ADMINS_PENDING = 'GET_DELETED_ADMINS_PENDING';
export const GET_DELETED_ADMINS_SUCCESS = 'GET_DELETED_ADMINS_SUCCESS';
export const GET_DELETED_ADMINS_ERROR = 'GET_DELETED_ADMINS_ERROR';
...
export const RESTORE_ADMIN_PENDING = 'RESTORE_ADMIN_PENDING';
export const RESTORE_ADMIN_SUCCESS = 'RESTORE_ADMIN_SUCCESS';
export const RESTORE_ADMIN_ERROR = 'RESTORE_ADMIN_ERROR';

export const REMOVE_ADMIN_PENDING = 'REMOVE_ADMIN_PENDING';
